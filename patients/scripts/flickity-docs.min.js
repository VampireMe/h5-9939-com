...
function(e, t, n) {
    ...
    r.isElement = "function" == typeof HTMLElement || "object" == typeof HTMLElement ?
    function(e) {
...
function(t, n, o) {
    ...
    function i() {}
    i.prototype = new n,
    i.prototype.bindStartEvent = function(t) {
    ...
    i.prototype.pointerDone = e,
    i.prototype.onMSPointerCancel = i.prototype.onpointercancel = function(t) {
...
function(t, n) {
    "use strict";
    "function" == typeof define && define.amd ? define(["eventie/eventie", "unipointer/unipointer"],
    function(e, i) {
        return n(t, e, i)
...
function(t, n, e) {
    ...
    r.prototype.pointerDown = function(e, i) {
        ...
        n.bind(t, "scroll", this),
        this.emitEvent("pointerDown", [e, i])
    },
    ...
    r.prototype.pointerMove = function(t, n) {
        ...
        this.emitEvent("pointerMove", [t, n, e]),
        this._dragMove(t, n, e)
    },
    r.prototype._dragPointerMove = function(t, n) {
        ...
        return ! this.isDragging && this.hasDragStarted(o) && this._dragStart(t, n),
        o
    },
    ...
    r.prototype._dragStart = function(t, n) {
        this.isDragging = !0,
        this.dragStartPoint = r.getPointerPoint(n),
    ...
    r.prototype.onscroll = function() {
        ...
        e = this.pointerDownScroll.y - t.y; (Math.abs(n) > 3 || Math.abs(e) > 3) && this._pointerDone()
    },
    ...
    r.getPointerPoint = e.getPointerPoint,
    r
}); !
function(t, e) {
    "use strict";
...
function(t, e) {
    ...
    o.prototype = new e,
    o.prototype.bindTap = function(t) {
...
function(t, i) {
    "use strict";
    "function" == typeof define && define.amd ? define(["get-style-property/get-style-property", "fizzy-ui-utils/utils"],
    function(e, s) {
        return i(t, e, s)
    }) : "object" == typeof exports ? module.exports = i(t, require("desandro-get-style-property"), require("fizzy-ui-utils")) : (t.Flickity = t.Flickity || {},
    t.Flickity.animatePrototype = i(t, t.getStyleProperty, t.fizzyUIUtils))
} (window,
function(t, i, e) {
    "use strict";
    for (var s, n = 0,
    r = "webkit moz ms o".split(" "), o = t.requestAnimationFrame, h = t.cancelAnimationFrame, l = 0; l < r.length && (!o || !h); l++) s = r[l],
    o = o || t[s + "RequestAnimationFrame"],
...
function(t, e) {
    "use strict";
    if ("function" == typeof define && define.amd) define(["classie/classie", "eventEmitter/EventEmitter", "eventie/eventie", "get-size/get-size", "fizzy-ui-utils/utils", "./cell", "./animate"],
    function(i, s, l, n, o, r, h) {
...
function(t, e, i, s, l, n, o, r) {
    ...
    function c(t, e) {
        ...
        return i ? (this.element = i, a && (this.$element = a(this.element)), this.options = n.extend({},
        this.constructor.defaults), this.option(e), void this._create()) : void(p && p.error("Bad element for Flickity: " + (i || t)))
    }
    var a = t.jQuery,
    ...
    c.createMethods = [],
    n.extend(c.prototype, i.prototype),
    c.prototype._create = function() {
        ...
        this._createSlider(),
        (this.options.resize || this.options.watchCSS) && (s.bind(t, "resize", this), this.isResizeBound = !0);
        for (var i = 0,
        l = c.createMethods.length; l > i; i++) {
    ...
    c.prototype.activate = function() {
        if (!this.isActive) {
            ...
            this.reloadCells(),
            this.options.accessibility && (this.element.tabIndex = 0, s.bind(this.element, "keydown", this)),
            this.emit("activate"),
    ...
    c.prototype._positionCells = function(t) {
        ...
        for (var s, l = this.cells.length,
        n = t; l > n; n++) s = this.cells[n],
        s.setPosition(e),
        e += s.size.outerWidth,
    ...
    c.prototype._containCells = function() {
        if (this.options.contain && !this.options.wrapAround && this.cells.length) for (var t = this.options.rightToLeft ? "marginRight": "marginLeft", e = this.options.rightToLeft ? "marginLeft": "marginRight", i = this.cells[0].size[t], s = this.getLastCell(), l = this.slideableWidth - s.size[e], n = l - this.size.innerWidth * (1 - this.cellAlign), o = l < this.size.innerWidth, r = 0, h = this.cells.length; h > r; r++) {
            var c = this.cells[r];
            c.setDefaultTarget(),
            o ? c.target = l * this.cellAlign: (c.target = Math.max(c.target, this.cursorPosition + i), c.target = Math.min(c.target, n))
        }
    },
    ...
    c.prototype.select = function(t, e) {
        if (this.isActive) {
            ...
            (this.options.wrapAround || e) && (t = n.modulo(t, i)),
    ...
    n.debounceMethod(c, "onresize", 150),
    ...
    c.prototype.destroy = function() {
        this.deactivate(),
        this.isResizeBound && s.unbind(t, "resize", this),
        this.emit("destroy"),
    ...
    n.htmlInit(c, "flickity"),
    a && a.bridget && a.bridget("flickity", c),
    c.Cell = o,
    c
}); !
function(t, e) {
    "use strict";
    "function" == typeof define && define.amd ? define(["classie/classie", "eventie/eventie", "./flickity", "unidragger/unidragger", "fizzy-ui-utils/utils"],
    function(i, o, r, n, s) {
...
function(t, e, i, o, r, n) {
    ...
    o.createMethods.push("_createDrag"),
    n.extend(o.prototype, r.prototype),
    o.prototype._createDrag = function() {
    ...
    o.prototype.pointerDown = function(o, n) {
        if ("INPUT" == o.target.nodeName && "range" == o.target.type) return this.isPointerDown = !1,
        void delete this.pointerIdentifier;
        this._dragPointerDown(o, n);
        var s = document.activeElement;
        s && s.blur && s != this.element && s != document.body && s.blur(),
        this.pointerDownFocus(o),
        this.dragX = this.x,
        e.add(this.viewport, "is-pointer-down"),
        this._bindPostStartEvents(o),
        this.pointerDownScroll = r.getScrollPosition(),
        i.bind(t, "scroll", this),
        this.dispatchEvent("pointerDown", o, [n])
    };
    var h = {
        touchstart: !0,
        MSPointerDown: !0
    ...
    o.prototype.pointerDownFocus = function(t) { ! this.options.accessibility || h[t.type] || l[t.target.nodeName] || this.element.focus()
    },
    ...
    return o.prototype.touchVerticalScrollMove = function(e, i, o) {
        ...
        n = "withDrag" == r ? !r: this.isDragging || !r; ! n && c[e.type] && !this.isTouchScrolling && Math.abs(o.y) > 10 && (this.startScrollY = t.pageYOffset, this.pointerWindowStartY = a(i), this.isTouchScrolling = !0)
    },
    ...
    o.prototype._getClosestResting = function(t, e, i) {
        for (var o = this.selectedIndex,
        r = 1 / 0,
        n = this.options.contain && !this.options.wrapAround ?
        function(t, e) {
            return e >= t
        }: function(t, e) {
            return e > t
...
function(t, e) {
    "use strict";
    "function" == typeof define && define.amd ? define(["eventie/eventie", "./flickity", "tap-listener/tap-listener", "fizzy-ui-utils/utils"],
    function(i, n, s, r) {
        return e(t, i, n, s, r)
...
function(t, e, i, n, s) {
    ...
    h = function() {
        function t() {
            ...
            e = (t.firstChild && t.firstChild.namespaceURI) == a
        }
        var e;
        return t
    } ();
    return r.prototype = new n,
...
function(t, e, o, i, s) {
    ...
    o.createMethods.push("_createPageDots"),
    o.prototype._createPageDots = function() {
...
function(t, e) {
    "use strict";
    "function" == typeof define && define.amd ? define(["eventEmitter/EventEmitter", "eventie/eventie", "./flickity"],
    function(t, i, n) {
        return e(t, i, n)
...
function(t, e, i) {
    ...
    var s, o;
    return "hidden" in document ? (s = "hidden", o = "visibilitychange") : "webkitHidden" in document && (s = "webkitHidden", o = "webkitvisibilitychange"),
    n.prototype = new t,
    ...
    i.prototype.deactivatePlayer = function() {
        this.player.stop(),
        this.isMouseenterBound && (e.unbind(this.element, "mouseenter", this), delete this.isMouseenterBound)
    },
...
function(e, t) {
    "use strict";
    "function" == typeof define && define.amd ? define(["./flickity", "fizzy-ui-utils/utils"],
    function(i, l) {
        return t(e, i, l)
...
function(e, t, i) {
    ...
    t.prototype.remove = function(e) {
        ...
        for (t = 0, l = n.length; l > t; t++) s = n[t],
        s.remove(),
        i.removeFrom(this.cells, s);
    ...
    t.prototype.cellChange = function(e, t) {
        ...
        this._getWrapShiftCells(),
        this.setGallerySize(),
        this.options.freeScroll ? (this.x += i - this.slideableWidth, this.positionSlider()) : (t && this.positionSliderAtSelected(), this.select(this.selectedIndex))
    },
    t
}); !
function(t, i) {
    "use strict";
    "function" == typeof define && define.amd ? define(["classie/classie", "eventie/eventie", "./flickity", "fizzy-ui-utils/utils"],
    function(e, o, l, a) {
        return i(t, e, o, l, a)
...
function(t, i, e, o, l) {
    ...
    return o.createMethods.push("_createLazyload"),
    o.prototype._createLazyload = function() {
    ...
    n.prototype.handleEvent = l.handleEvent,
    n.prototype.load = function() {
        e.bind(this.img, "load", this),
        e.bind(this.img, "error", this),
    ...
    n.prototype.complete = function(t, o) {
        e.unbind(this.img, "load", this),
        e.unbind(this.img, "error", this);
...
function(e, i, t) {
    "use strict";
    return i.createMethods.push("_createImagesLoaded"),
    i.prototype._createImagesLoaded = function() {
        this.on("activate", this.imagesLoaded)
    },
    i.prototype.imagesLoaded = function() {
        function e(e, t) {
            var o = i.getParentCell(t.img);
            i.cellSizeChange(o && o.element),
...
function(e, t) {
    "use strict";
    "function" == typeof define && define.amd ? define(["classie/classie", "flickity/js/index", "fizzy-ui-utils/utils"],
    function(i, n, o) {
        return t(e, i, n, o)
...
function(e, t, i, n) {
    "use strict";
    return i.createMethods.push("_createAsNavFor"),
    ...
    i.prototype.navCompanionSelect = function() {
        if (this.navCompanion) {
            ...
            this.selectedIndex == e && (this.navSelectedElement = this.cells[e].element, t.add(this.navSelectedElement, "is-nav-selected"))
        }
    },
...
function(t, e) {
    "use strict";
    "function" == typeof define && define.amd ? define(["classie/classie", "get-style-property/get-style-property", "get-size/get-size", "unidragger/unidragger"],
    function(i, n, o, s) {
        return e(t, i, n, o, s)
...
function(t, e, i, n, o) {
    ...
    function a(t, e) {
        this.element = "string" == typeof t ? l.querySelector(t) : t,
        b && (this.$element = b(this.element)),
        this.options = r({},
    ...
    for (var h, l = t.document,
    d = l.defaultView,
    u = d && d.getComputedStyle ?
    function(t) {
    ...
    g = 0, y = "webkit moz ms o".split(" "), f = t.requestAnimationFrame, m = t.cancelAnimationFrame, v = 0; v < y.length && (!f || !m); v++) h = y[v],
    f = f || t[h + "RequestAnimationFrame"],
    m = m || t[h + "CancelAnimationFrame"] || t[h + "CancelRequestAnimationFrame"];
    f && m || (f = function(e) {
    ...
    a.prototype.containDrag = function(t, e, i) {
        ...
        return r = p(r, i, "floor"),
        Math.min(r, Math.max(s, e))
    },
    ...
    a.prototype._init = s,
    b && b.bridget && b.bridget("draggabilly", a),
    a
}); !
function(e) {
    "use strict";
    ...
    l.modules = {},
    l.makeCellElem = function(e) {
        var l = document.createElement("div");
        l.className = "gallery-cell";
        var t = document.createElement("span");
        return t.className = "gallery-cell__number",
        utils.setText(t, e),
        l.appendChild(t),
        l
    },
...
FlickityDocs.modules["arrow-wiz"] = function(e) {
    ...
    function i() {
        ...
        s.beginPath(),
        s.moveTo(2 * w[0].x, 100),
        s.lineTo(2 * w[1].x, 100 - 2 * w[1].y),
        s.lineTo(2 * w[2].x, 100 - 2 * w[2].y),
        s.lineTo(2 * w[3].x, 100),
        s.lineTo(2 * w[2].x, 100 + 2 * w[2].y),
        s.lineTo(2 * w[1].x, 100 + 2 * w[1].y),
        s.lineTo(2 * w[0].x, 100),
        s.fill(),
        s.stroke(),
        s.closePath()
    }
...
FlickityDocs.modules["custom-nav"] = function(e) {
    ...
    function() {
        ...
        classie.remove(e, "is-selected"),
        classie.add(t, "is-selected")
    }),
...
FlickityDocs.modules.destroy = function(e) {
    ...
    eventie.bind(l, "click",
    function() {
        c ? i.destroy() : i = new Flickity(t),
        c = !c
    })
};
FlickityDocs.modules.events = function(e) {
    ...
    function t(e, t) {
        ...
        n.className = "event-table__time",
        c.className = "event-table__event",
        r.className = "event-table__message";
        var i = new Date,
...
docReady(function() {
    "use strict";
    for (var t = window.Stickeroo,
    e = document.querySelectorAll(".js-stickeroo"), i = 0, s = e.length; s > i; i++) {
        var n = e[i];
        new t(n)
    }
});
...
FlickityDocs.modules["static-click"] = function(i) {
    ...
    function(i, l, s, r) {
        if (s) {
            ...
            o && classie.remove(o, "is-clicked"),
            classie.add(s, "is-clicked"),
            e.setText(t, "Cell " + (r + 1) + " clicked")
        }
    })
};