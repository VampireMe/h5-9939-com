var appUI = {
    ...
    buildChatContainer:function(){
        var html = [];
        html.push('<div id="div_chat_container">');
        html.push("<div style=\"text-align:right;height:30px;background-color:#e5f4ff;font-size:14px;\"><a id=\"btn_close\" name=\"btn_close\">关闭</a></div>");
        html.push('<div class="bad-network hide tc radius5px" id="j-errorNetwork">已与服务器断开，请检查网络连接</div>');
        html.push('    <div class="wrapper box-sizing">');
        html.push('        <div class="content">');
        html.push('            <div class="right-panel hide radius5px" id="j-rightPanel">');
        html.push('                <div class="chat-box">');
        html.push('                    <div class="chat-content box-sizing" id="j-chatContent"> ');

        html.push('                    </div>');
        html.push('                    <div class="u-chat-notice"></div>');
        html.push('                    <div class="chat-mask"></div>');
        html.push('                    <div class="chat-editor box-sizing" id="j-chatEditor" data-disabled="1">');
        html.push('                        <div id="emojiTag" class="m-emojiTag"></div>');
        html.push('                        <a href="javascript:;" class="u-emoji" id="j-showEmoji"></a>');
        html.push('                        <span class="msg-type" id="j-msgType">');
        html.push('                            <a href="javascript:;" class="icon icon-file" data-type="file"></a>');
        html.push('                        </span>');
        html.push('                        <form action="#" id="j-uploadForm">');
        html.push('                            <input multiple="multiple" type="file" name="file" id="j-uploadFile" class="hide"/>');
        html.push('                        </form>');
        html.push('                        <textarea id="j-messageText" class="msg-input box-sizing radius5px" rows="1" autofocus="autofocus" maxlength="500"></textarea>');
        html.push('                        <a href="javascript:;" class="btn-send radius5px" id="j-sendBtn">发送</a>');
        html.push('                    </div>');
        html.push('                </div>');
        html.push('            </div>');
        html.push('        </div>');
